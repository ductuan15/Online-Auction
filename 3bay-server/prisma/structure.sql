...
CREATE TABLE `auctions` (
  ...
  `winnerBidderId` int DEFAULT NULL,
...
CREATE TABLE `categories` (
  `id` int NOT NULL AUTO_INCREMENT,
  `title` varchar(28) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  ...
  CONSTRAINT `categories_fk0` FOREIGN KEY (`parent_id`) REFERENCES `categories` (`id`),
...
CREATE TABLE `upgrade_to_bidder_requests` (
  ...
  PRIMARY KEY (`userId`),
  CONSTRAINT `upgrade_to_bidder_requests_fk0` FOREIGN KEY (`userId`) REFERENCES `users` (`uuid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `user_watchlist` (
  ...
  CONSTRAINT `user_watchlist_fk0` FOREIGN KEY (`userId`) REFERENCES `users` (`uuid`),
...
-- Dump completed on 2021-12-06  0:19:07